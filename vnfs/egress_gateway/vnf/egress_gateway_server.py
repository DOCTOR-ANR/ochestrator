...
from egress_gateway_em import EgressGatewayEM
import sys
import logging
...
eGW_em = EgressGatewayEM(logger, vnfm_host, vnfm_port)
logger.debug('egress_gw EM is UP')


def enforce_initial_config(config):
    eGW_em.enforce_initial_configuration(config)
