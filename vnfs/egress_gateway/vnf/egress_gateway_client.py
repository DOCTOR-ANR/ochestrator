...
class EgressGatewayClient(GenericClient):
    """ formats and sends requests to configure faces """

    def __init__(self, logger, vnfm_host, vnfm_port=3999 ):
        GenericClient.__init__(self, logger, vnfm_host,vnfm_port,"eGW")
        print  ("egress gateway client UP")
        ...
        while True:
            try:
                ...
                config = {"container":containerID,
                        ...
                        "listening_port":4999}
                self.send_request('POST', 'notifications/eGW_UP', config)
